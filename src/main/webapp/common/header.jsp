...
<div class="container"><img class="img-responsive" src="static/images/logo-PX.png"></div>
<!--导航-->    
  ...
  <div class="container">    
	...
	<li class="dropdown">
		...
		<ul class="dropdown-menu" role="menu">
			<li><a href="product/1">减速机</a></li>
			<li><a href="product/2">机械手臂</a></li>
			<li><a href="product/3">动力刀塔</a></li>
			<li><a href="product/4">齿轮齿条</a></li>
			<li><a href="product/5">扭力扳手</a></li>
		</ul>
	</li>
...
<a class="navbar-fixed-top pull-right" style="margin-top:300px;width:100px" target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=3285443540&site=qq&menu=yes"><img border="0" src="http://wpa.qq.com/pa?p=2:3285443540:53" alt="点击这里给我发消息" title="点击这里给我发消息"/></a>